...
# Default preset
$preset = @(
 "DisableAutoNetD",              # "EnableAutoNetD"
	### Privacy Settings ###
...
# Vyp automatickou inst sit. zar.
Function DisableAutoNetD {
	Write-Host "Vyp automatickou inst sit. zar."
	Set-ItemProperty -Path "HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\DriverSearching" -Name "SearchOrderConfig" -Type DWord -Value 0
}


# Zap automatickou inst sit. zar.
Function EnableAutoNetD {
	Write-Host "Zap automatickou inst sit. zar."
